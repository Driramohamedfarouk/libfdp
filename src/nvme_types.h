#pragma once
// This header is private to the fdp implementation: none of it is part of
// the public library interface (see include/fdp.h), so it lives under src/
...
// --- fdp-internal device state (not derived from libnvme) ---
//
