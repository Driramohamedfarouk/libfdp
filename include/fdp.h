...
/** For now the fdp_dev_t* is the handle to the device. Change this
to return a file descriptor on success and a well defined error code on failure.
All other methods should interact with the fdp device with the
